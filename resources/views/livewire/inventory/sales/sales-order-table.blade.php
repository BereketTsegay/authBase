<div class="min-h-screen bg-gray-900 py-8 px-4 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-7xl">
        <div class="mb-8 flex items-center justify-between">
            <div>
                <h1 class="text-4xl font-bold text-white">Sales Orders</h1>
                <p class="mt-2 text-gray-400">Track and manage your sales orders</p>
            </div>
        ...
        <div class="rounded-lg border border-gray-700 bg-gray-800 overflow-hidden">
            <table class="w-full text-left text-sm text-gray-300">
                <thead class="border-b border-gray-700 bg-gray-900">
                    <tr>
                        <th class="px-6 py-4 font-semibold">SO Number</th>
                        <th class="px-6 py-4 font-semibold">Customer Email</th>
                ...
                <tbody class="divide-y divide-gray-700">
                    @forelse ($salesOrders as $order)
                        <tr class="hover:bg-gray-750">
                            <td class="px-6 py-4 text-white">{{ $order['so_number'] ?? '-' }}</td>
                            ...
                            <td class="px-6 py-4">
                                <span class="rounded-full px-2 py-1 text-xs font-semibold bg-purple-900 text-purple-200">
